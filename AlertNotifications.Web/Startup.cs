...
using AlertNotifications.Core.Banner;
using AlertNotifications.Core.Extensions;
using AlertNotifications.Core.Logging;
using AlertNotifications.Core.Sockets;
using AlertNotifications.Core.Upload;
using AlertNotifications.Data;
using AlertNotifications.Identity;
using AlertNotifications.Web.Hubs;
using AlertNotifications.Identity.Mock;
using System.Text;

namespace AlertNotifications.Web
{
